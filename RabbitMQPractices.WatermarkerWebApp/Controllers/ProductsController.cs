...
namespace RabbitMQPractices.WatermarkerWebApp.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(MyContext context, RabbitMQPublisher rabbitMQPublisher)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,Stock,ImageUrl")] Product product, IFormFile ImageFile)
        {
            ...
            if (ImageFile is { Length: > 0 })
            {
                ...
                _rabbitMQPublisher.Publish(new ProductImageCreatedEvent() { ImageUrl = randomImageName });
